...
The current suite contains 300 tests across 12 files. Counts are a snapshot, not
...
| [test_hybrid_ocr.py](../tests/test_hybrid_ocr.py) | 29 | OCR settings, Tesseract coordinates/confidence, Unlimited client security/errors/temp cleanup, deep integration and ambient block. |
...
| [test_screen_monitoring_reliability.py](../tests/test_screen_monitoring_reliability.py) | 57 | Coordinate/origin/capture/concurrency/change/event/pattern/privacy/stale-result/backward-compatibility matrix. |
