...
The current suite contains 318 tests across 12 files. Counts are a snapshot, not
...
| [test_screen_monitoring_reliability.py](../tests/test_screen_monitoring_reliability.py) | 69 | Coordinate/origin/capture/concurrency/change/event/pattern/privacy/stale-result/backward-compatibility matrix. |
