...
> A modified fork of [Agetha.exe](https://chocolatebread.ddns.net/agetha.html) (v5.1.0) with enhanced desktop integration, spatial OCR, emotional AI, native safety confirmations, and expanded OS control.
